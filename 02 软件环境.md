...
sudo apt-get install python-dev python-pip libxml2-dev libxslt1-dev zlib1g-dev libffi-dev libssl-dev(do before 'pip3 install jupyter notebook jupyterlab')
```
- python库安装
```
pip3 install cython
